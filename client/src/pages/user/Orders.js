...
const Orders = () => {
    ...
    const getOrders = async () => {
        try {
            const { data } = await axios.get("https://zorox-intern-project.onrender.com/api/v1/auth/orders");
            setOrders(data);
        } catch (error) {
            console.log(error);
        }
                ...
                <div className="row">
                    ...
                    <div className="col-lg-8 ">
                        ...
                        {orders?.map((o, i) => {
                            ...
                            return (
                                <div key={o._id} className="border shadow p-2 mb-3 mt-2" style={{ backgroundColor: 'orange', borderRadius: "4px" }}>
                                            ...
                                            <div className="row mb-2 p-2 card flex-row" key={p._id}>
                                                ...
                                                <div className='col-12 col-md-8'>
                                                    <div className="mt-3">
                                                        ...
                                                        <h6 className='text-primary'> Total :₹ {p.quantity * p.price}</h6>
                                                    </div>
                                                </div>
                                            </div>
